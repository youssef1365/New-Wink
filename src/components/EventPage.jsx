...
const allEvents = [
  { id: 1,  type: 'upcoming', name: 'FOODEX JAPAN 2026', location: 'Japan', date: 'March 10–13, 2026', sector: 'Agri-food', details: "Morocco will showcase the richness and diversity of its agri-food sector at FOODEX Japan 2026, one of Asia's leading international food and beverage exhibitions. From fresh fruits and vegetables to processed snacks, aromatic herbs, premium olive and terroir oils, and seafood products, Moroccan exhibitors present solutions tailored to the needs of international markets." },
  { id: 2,  type: 'upcoming', name: 'Moroccan Business Mission for Agri-food & Fresh Products', location: 'Jaal Hotel Marrakech', date: 'March 26, 2026', sector: 'Agri-food', details: 'The Morocco Food & Fresh Produce Incoming Business Mission 2026, hosted in Marrakech, is an exclusive B2B initiative to strengthen international trade partnerships. It combines curated B2B matchmaking meetings, market discovery activities, and networking opportunities in a premium business setting.' },
  { id: 3,  type: 'upcoming', name: 'International Food & Drink Event (IFE) 2026', location: 'ExCeL London, United Kingdom', date: '30 March – 01 April 2026', sector: 'Food & Drink', details: 'IFE is the ultimate business event for food & drink product discovery, bringing together over 25,000 verified trade visitors, expert speakers, and global exhibitors from across the food & beverage industry.' },
  { id: 4,  type: 'upcoming', name: 'Moroccan Trade Mission – Olive Oil Industry in New York', location: 'New York City', date: 'March 27, 2026', sector: 'Olive Oil', details: 'Designed to showcase the excellence of Moroccan olive oil to the North American market, this B2B initiative connects selected Moroccan exporters with leading American importers and distributors, promoting long-term commercial partnerships.' },
  { id: 5,  type: 'past', name: 'The Moroccan Seafood Trade Mission in Ghana', location: 'Ghana', date: 'December 9, 2025', sector: 'Seafood', details: "A high-level B2B event connecting Moroccan seafood exporters with Ghanaian importers, distributors, and buyers. Highlights the excellence of Morocco's seafood industry — from canned fish to value-added marine products.", results: { meetings: 70, buyers: 41 }, photos: ['/PHOTOS-POUR-LE-SITE-WEB/GHANA-FOODEX/ghana1.jpeg', '/PHOTOS-POUR-LE-SITE-WEB/GHANA-FOODEX/ghana2.jpeg'] },
  { id: 6,  type: 'past', name: '8th China International Import Expo (CIIE 2025)', location: 'China', date: 'November 5–10, 2025', sector: 'Agri-food', details: "The Morocco Foodex Pavilion at CIIE 2025 highlights Morocco's dynamic agri-food sector and its growing partnership with China, including key national institutions committed to strengthening trade and investment.", results: { meetings: 60, buyers: 37 }, photos: ['/PHOTOS-POUR-LE-SITE-WEB/China-Moroccofoodex/china1.jpeg', '/PHOTOS-POUR-LE-SITE-WEB/China-Moroccofoodex/china2.jpeg', '/PHOTOS-POUR-LE-SITE-WEB/China-Moroccofoodex/china3.jpeg'] },
  { id: 7,  type: 'past', name: 'KOREA BUILD WEEK 2025', location: 'Korea', date: 'July 30 – Aug 2, 2025', sector: 'Construction', details: 'KOREA BUILD WEEK 2025 brings together global leaders in building materials, interior design, construction equipment, and smart building technologies — the go-to platform to discover the future of construction in Asia.', results: { meetings: 81, buyers: 48 }, photos: ['/PHOTOS-POUR-LE-SITE-WEB/KOREA-BUILDWEEK/korea1.jpeg', '/PHOTOS-POUR-LE-SITE-WEB/KOREA-BUILDWEEK/korea2.jpeg'] },
  { id: 8,  type: 'past', name: 'Mission commerciale du textile et des matières premières', location: 'Casablanca, Morocco', date: 'November 5–7, 2025', sector: 'Textile', details: "Un événement B2B réunissant une délégation d'entreprises turques leaders du secteur agroalimentaire et des importateurs marocains qualifiés à la recherche de nouveaux partenariats durables.", results: { meetings: 942, buyers: 247 } },
  { id: 9,  type: 'past', name: 'GULFOOD 2026', location: 'Expo City Dubai', date: 'January 26–30, 2026', sector: 'Food & Drink', details: "Gulfood is the world's largest and most influential food and beverage exhibition. Discover new trends, launch products, connect with high-level buyers, and transform meetings into long-term commercial partnerships.", results: { meetings: 260, buyers: 162 }, photos: ['/PHOTOS-POUR-LE-SITE-WEB/GULFOOD-2026/gulfood1.jpeg', '/PHOTOS-POUR-LE-SITE-WEB/GULFOOD-2026/gulfood2.jpeg'] },
  { id: 10, type: 'past', name: 'Conxemar 2025', location: 'Vigo, Spain', date: 'October 7–9, 2025', sector: 'Seafood', details: 'Salon international de référence pour les produits de la mer surgelés. La mission vise à positionner les acteurs marocains et internationaux face aux acheteurs européens et mondiaux.', results: { meetings: 177, buyers: 61 } },
  { id: 11, type: 'past', name: 'Big 5 Global Dubai', location: 'Dubai World Trade Centre', date: 'November 24–27, 2025', sector: 'Construction', details: 'Taking place at the Dubai World Trade Centre, Big 5 Global is the largest construction event in the Middle East and Africa.', results: { meetings: 142, buyers: 94 }, photos: ['/PHOTOS-POUR-LE-SITE-WEB/BIG5-2025/big51.jpeg', '/PHOTOS-POUR-LE-SITE-WEB/BIG5-2025/big52.jpeg'] },
  { id: 12, type: 'past', name: 'ADIFE 2025', location: 'Abu Dhabi', date: 'November 2025', sector: 'Food & Drink', details: "Salon stratégique à Abu Dhabi pour le secteur F&B et l'hôtellerie, mettant l'accent sur les innovations alimentaires et les partenariats dans le Golfe.", results: { meetings: 255, buyers: 85 }, photos: ['/PHOTOS-POUR-LE-SITE-WEB/ADIF-2025/adif1.jpeg', '/PHOTOS-POUR-LE-SITE-WEB/ADIF-2025/adif2.jpeg'] },
];

const SECTORS = ['All', ...Array.from(new Set(allEvents.map(e => e.sector)))];
...
function Ticker() {
  ...
  return (
      <div className="ep-ticker-wrap">
        <motion.div
            className="ep-ticker-inner"
            animate={{ x: ['0%', '-50%'] }}
            transition={{ duration: 22, repeat: Infinity, ease: 'linear' }}
        >
          {doubled.map((item, i) => (
              <span key={i} className="ep-ticker-item">
            {item} <span className="ep-ticker-dot">✦</span>
          </span>
          ))}
        </motion.div>
      </div>
        ...
        <div className="ep-overlay" onClick={onClose}>
          ...
          >
            ...
            <div className="ep-modal-tag">
              ...
              {event.type === 'upcoming' ? 'Upcoming Event' : 'Past Event'} · {event.sector}
            </div>
            ...
            {event.results && (
                <div className="ep-modal-stats">
                  <div className="ep-modal-stat">
                    <span>{event.results.meetings.toLocaleString()}</span>
                    <small>B2B Meetings</small>
                  </div>
                  <div className="ep-modal-stat">
                    <span>{event.results.buyers.toLocaleString()}</span>
                    <small>Buyers</small>
                  </div>
                </div>
            )}
  ...
  return (
      ...
      >
        ...
        <div className="ep-uc-body">
          ...
          <button className="ep-uc-cta" onClick={e => { e.stopPropagation(); onClick(); }}>
...
export default function EventsPage() {
  ...
  useEffect(() => {
    const fn = (e) => {
      if (e.key === 'Escape') { lightboxSrc ? setLightboxSrc(null) : setSelectedEvent(null); }
    };
    window.addEventListener('keydown', fn);
    return () => window.removeEventListener('keydown', fn);
  }, [lightboxSrc]);

  const visible = allEvents.filter(e => e.type === filter && (sector === 'All' || e.sector === sector));
  const cardVariants = {
    hidden: { opacity: 0, y: 32 },
        ...
        <section className="ep-hero" ref={heroRef}>
          ...
          <motion.div className="ep-hero-content" style={{ opacity: heroOpacity }}>
            ...
            <motion.h1 className="ep-hero-title" initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.1 }}>
              Our<span className="ep-hero-accent"> Events</span>
            </motion.h1>
        ...
        <main className="ep-main">
          ...
          <div className="ep-filter-bar" id="events-anchor">
            <div className="ep-tabs">
              <button className={`ep-tab ${filter === 'upcoming' ? 'active' : ''}`} onClick={() => { setFilter('upcoming'); setSector('All'); }}>
                ⟢ Upcoming Events
              </button>
              <button className={`ep-tab ${filter === 'past' ? 'active' : ''}`} onClick={() => { setFilter('past'); setSector('All'); }}>
                ◎ Past Events
              </button>
            </div>
            <div className="ep-sectors">
              {SECTORS.map(s => (
                  <button key={s} className={`ep-sector-pill ${sector === s ? 'active' : ''}`} onClick={() => setSector(s)}>{s}</button>
              ))}
            </div>
          </div>
          ...
          <div className="ep-count-label">
            <AnimatePresence mode="wait">
              <motion.span key={`${filter}-${sector}`} initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                {visible.length} event{visible.length !== 1 ? 's' : ''}{sector !== 'All' ? ` · ${sector}` : ''}
              </motion.span>
            </AnimatePresence>
          </div>
              ...
              {visible.map((event, i) =>
                  event.type === 'upcoming' ? (
                      ...
                      <motion.article
                          ...
                          initial="hidden" animate="show" exit="exit" custom={i} layout
                    ...
                    <span className="ep-card-meta-item">
                      ...
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                          ...
                          <span className="ep-card-meta-item ep-card-desc-preview">
                      {event.details.slice(0, 90)}…
                    </span>
                        </div>
                        {event.results && (
                            <div className="ep-card-results">
                              <div className="ep-card-result">
                                <span>{event.results.meetings}</span>
                                <small>meetings</small>
                              </div>
                              <div className="ep-card-result-div" />
                              <div className="ep-card-result">
                                <span>{event.results.buyers}</span>
                                <small>buyers</small>
                              </div>
                            </div>
                        )}
...
const CSS = `
  ...
  .ep-filter-bar { display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1.2rem; margin-bottom: 1.5rem; padding-bottom: 1.5rem; border-bottom: 1px solid rgba(0,206,193,0.12); }
  ...
  .ep-tab { background: none; border: none; color: var(--color-third); opacity: 0.55; padding: 0.55rem 1.4rem; border-radius: 100px; cursor: pointer; font-size: 0.82rem; font-weight: 700; font-family: 'DM Sans', sans-serif; letter-spacing: 0.02em; transition: all var(--transition); }
  .ep-tab.active { background: var(--color-one); color: var(--color-two); opacity: 1; }
  .ep-sectors { display: flex; gap: 0.5rem; flex-wrap: wrap; }
  .ep-sector-pill { background: none; border: 1px solid rgba(0,206,193,0.12); color: var(--color-third); opacity: 0.55; padding: 0.3rem 0.9rem; border-radius: 100px; cursor: pointer; font-size: 0.72rem; font-weight: 600; font-family: 'DM Sans', sans-serif; letter-spacing: 0.04em; transition: all var(--transition); }
  .ep-sector-pill:hover { border-color: var(--color-one); color: var(--color-one); opacity: 1; }
  .ep-sector-pill.active { background: rgba(0,206,193,0.08); border-color: var(--color-one); color: var(--color-one); opacity: 1; }
  ...
  .ep-uc { cursor: pointer; border-radius: var(--border-radius); overflow: hidden; background: var(--color-two); filter: brightness(1.08); border: 1px solid rgba(0,206,193,0.12); display: flex; flex-direction: column; transition: border-color var(--transition), transform 0.35s cubic-bezier(0.22,1,0.36,1), box-shadow 0.35s ease; }
  ...
  .ep-uc-city { position: absolute; bottom: 14px; left: 14px; z-index: 3; color: white; font-size: 1.6rem; font-weight: 900; text-transform: uppercase; letter-spacing: -0.03em; text-shadow: 0 2px 12px rgba(0,0,0,0.6); line-height: 1; font-family: 'DM Sans', sans-serif; }
  ...
  .ep-uc-name { font-family: 'DM Serif Display', serif; font-size: 1.15rem; color: var(--color-third); line-height: 1.25; letter-spacing: -0.01em; margin: 0; transition: color var(--transition); }
  ...
  .ep-card-glow { position: absolute; top: 0; left: 0; right: 0; height: 200px; background: radial-gradient(ellipse 60% 40% at 50% 0%, rgba(0,206,193,0.07), transparent); pointer-events: none; opacity: 0; transition: opacity var(--transition); }
  ...
  .ep-card-name { font-family: 'DM Serif Display', serif; font-size: 1.35rem; color: var(--color-third); line-height: 1.2; letter-spacing: -0.01em; transition: color var(--transition); }
  ...
  .ep-card-cta { display: inline-flex; align-items: center; gap: 0.4rem; background: none; border: 1px solid rgba(0,206,193,0.12); color: var(--color-third); opacity: 0.6; padding: 0.55rem 1.1rem; border-radius: var(--border-radius); font-size: 0.78rem; font-weight: 700; font-family: 'DM Sans', sans-serif; cursor: pointer; align-self: flex-start; margin-top: 0.5rem; transition: all var(--transition); }
  .ep-card:hover .ep-card-cta { border-color: var(--color-one); color: var(--color-one); opacity: 1; background: rgba(0,206,193,0.06); }

  .ep-empty { text-align: center; padding: 4rem; color: var(--color-third); opacity: 0.5; font-size: 0.95rem; }

  .ep-overlay { position: fixed; inset: 0; z-index: 9000; background: rgba(0,0,0,0.65); backdrop-filter: blur(8px); -webkit-backdrop-filter: blur(8px); display: flex; align-items: center; justify-content: center; padding: 2rem; }
  .ep-modal { position: relative; background: var(--color-two); border: 1px solid rgba(0,206,193,0.2); border-radius: 20px; padding: 2.5rem; width: 100%; max-width: 760px; max-height: 88vh; overflow-y: auto; box-shadow: 0 40px 100px rgba(0,0,0,0.5); }
  .ep-modal-stripe { position: absolute; top: 0; left: 2.5rem; right: 2.5rem; height: 2px; background: linear-gradient(90deg, var(--color-one), var(--color-fourth), transparent); border-radius: 0 0 2px 2px; }
  .ep-modal-close { position: absolute; top: 1.2rem; right: 1.2rem; background: rgba(209,219,220,0.06); border: 1px solid rgba(209,219,220,0.1); border-radius: 50%; width: 34px; height: 34px; display: flex; align-items: center; justify-content: center; cursor: pointer; color: var(--color-third); transition: all var(--transition); }
  .ep-modal-close:hover { background: rgba(209,219,220,0.15); }
  .ep-modal-tag { display: inline-flex; align-items: center; gap: 0.5rem; font-size: 0.6rem; font-weight: 800; letter-spacing: 0.18em; text-transform: uppercase; color: var(--color-third); opacity: 0.6; border: 1px solid rgba(0,206,193,0.15); padding: 0.25rem 0.75rem; border-radius: 100px; margin-bottom: 1.2rem; }
  .ep-modal-tag-dot { width: 6px; height: 6px; border-radius: 50%; }
  .ep-modal-tag-dot.upcoming { background: var(--color-fourth); }
  .ep-modal-tag-dot.past { background: var(--color-one); }
  .ep-modal-title { font-family: 'DM Serif Display', serif; font-size: clamp(1.5rem, 3.5vw, 2rem); color: var(--color-third); line-height: 1.15; letter-spacing: -0.02em; margin-bottom: 1rem; }
  .ep-modal-meta { display: flex; gap: 1.2rem; flex-wrap: wrap; margin-bottom: 1.2rem; }
  .ep-modal-meta span { display: inline-flex; align-items: center; gap: 0.4rem; font-size: 0.8rem; font-weight: 600; color: var(--color-third); opacity: 0.6; }
  .ep-modal-meta svg { color: var(--color-one); opacity: 1; }
  .ep-modal-divider { height: 1px; background: linear-gradient(90deg, rgba(0,206,193,0.2), transparent); margin-bottom: 1.2rem; }
  .ep-modal-desc { font-size: 0.88rem; color: var(--color-third); opacity: 0.7; line-height: 1.8; margin-bottom: 1.5rem; }
  .ep-modal-stats { display: flex; gap: 1rem; padding: 1.2rem; background: rgba(0,206,193,0.05); border: 1px solid rgba(0,206,193,0.1); border-radius: var(--border-radius); margin-bottom: 1.5rem; }
  .ep-modal-stat { flex: 1; text-align: center; }
  .ep-modal-stat span { display: block; font-size: 2rem; font-weight: 800; color: var(--color-one); }
  .ep-modal-stat small { font-size: 0.62rem; text-transform: uppercase; letter-spacing: 0.12em; color: var(--color-third); opacity: 0.5; }
  .ep-modal-gallery { margin-bottom: 1.5rem; }
  .ep-modal-gallery-label { font-size: 0.7rem; text-transform: uppercase; letter-spacing: 0.1em; color: var(--color-third); opacity: 0.5; margin-bottom: 0.7rem; }
  .ep-modal-gallery-label span { opacity: 0.5; text-transform: none; letter-spacing: 0; }
  .ep-modal-photos { display: grid; grid-template-columns: repeat(3, 1fr); gap: 0.5rem; }
  .ep-modal-photo { aspect-ratio: 4/3; border-radius: var(--border-radius); overflow: hidden; background: rgba(209,219,220,0.04); border: none; padding: 0; cursor: zoom-in; position: relative; display: block; }
  .ep-modal-photo img { width: 100%; height: 100%; object-fit: cover; opacity: 0.8; transition: opacity 0.2s, transform 0.3s ease; }
  .ep-modal-photo:hover img { opacity: 1; transform: scale(1.06); }
  .ep-photo-zoom { position: absolute; inset: 0; display: flex; align-items: center; justify-content: center; font-size: 1.3rem; color: var(--extra-color-one); background: rgba(0,0,0,0.35); opacity: 0; transition: opacity 0.2s; }
  .ep-modal-photo:hover .ep-photo-zoom { opacity: 1; }
  .ep-modal-footer { display: flex; align-items: center; gap: 1rem; padding-top: 1.5rem; border-top: 1px solid rgba(209,219,220,0.08); }
  .ep-modal-cta { background: linear-gradient(135deg, var(--color-one), var(--color-fourth)); color: var(--color-two); border: none; padding: 0.75rem 1.8rem; border-radius: 100px; font-size: 0.72rem; font-weight: 800; font-family: 'DM Sans', sans-serif; text-transform: uppercase; letter-spacing: 0.14em; cursor: pointer; transition: opacity var(--transition), transform var(--transition); }
  .ep-modal-cta:hover { opacity: 0.9; transform: translateY(-1px); }
  .ep-modal-dismiss { background: none; border: none; color: var(--color-third); opacity: 0.5; font-size: 0.82rem; font-weight: 600; font-family: 'DM Sans', sans-serif; cursor: pointer; transition: opacity var(--transition); }
  .ep-modal-dismiss:hover { opacity: 1; }

  .ep-lightbox { position: fixed; inset: 0; z-index: 9100; background: rgba(0,0,0,0.94); display: flex; align-items: center; justify-content: center; padding: 1rem; cursor: zoom-out; }
  .ep-lightbox-img { max-width: 100%; max-height: 90vh; border-radius: var(--border-radius); object-fit: contain; cursor: default; box-shadow: 0 40px 100px rgba(0,0,0,0.7); }
  .ep-lightbox-close { position: absolute; top: 1.2rem; right: 1.2rem; background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.2); border-radius: 50%; width: 44px; height: 44px; display: flex; align-items: center; justify-content: center; cursor: pointer; color: white; font-size: 1rem; transition: background var(--transition); }
  .ep-lightbox-close:hover { background: rgba(255,255,255,0.2); }

  @media (max-width: 768px) {
    .ep-filter-bar { flex-direction: column; align-items: flex-start; }
    .ep-grid { grid-template-columns: 1fr; }
    .ep-hero-stats { gap: 1.5rem; padding: 0.85rem 1.5rem; flex-wrap: wrap; border-radius: 16px; }
    .ep-overlay { padding: 1rem; }
    .ep-modal { padding: 1.8rem 1.2rem 1.5rem; }
    .ep-modal-photos { grid-template-columns: repeat(2, 1fr); }
    .ep-modal-stats { flex-direction: column; }
    .ep-uc-img { height: 180px; }
    .ep-uc-city { font-size: 1.2rem; }
  }

  .ep-modal::-webkit-scrollbar { width: 4px; }
  .ep-modal::-webkit-scrollbar-track { background: transparent; }
  .ep-modal::-webkit-scrollbar-thumb { background: rgba(0,206,193,0.3); border-radius: 4px; }
`;